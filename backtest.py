...
symbol=None
if pair == "BTCUSD":
    symbol=Symbol(symbol="BTCUSD", isInverse=True, tickSize=0.1, lotSize=1.0, makerFee=0.0002,takerFee=0.00055, quantityPrecision=2,pricePrecision=2)
elif pair == "XRPUSD":
    ...
    symbol=Symbol(symbol="BTCUSDT", isInverse=False, tickSize=0.1, lotSize=0.001, makerFee=0.0002,takerFee=0.00055, quantityPrecision=3,pricePrecision=2)
